...
if __name__ == '__main__':
    ...
    semantic_dir = f"./data_2d_semantics/train/{DRIVE}"
    ...
    for idx in range(len(start_end_list)):
        ...
        os.makedirs(f"colmap_dense_vis/semantic_label_pcd/{seq_name}", exist_ok=True)
        ...
        o3d.io.write_point_cloud(f"colmap_dense_vis/semantic_pcd/{seq_name}.ply", semantic_pcd)
